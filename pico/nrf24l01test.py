...
def master(msg):
    ...
    while num_successes < num_needed and num_failures < num_needed:
        ...
        if timeout:
            ...
            #Float
            #(got_msg,) = struct.unpack("h", nrf.recv())
            ...
            num_successes += 1
            #Break after 1 successful message, don't want to spam receiver
            break
